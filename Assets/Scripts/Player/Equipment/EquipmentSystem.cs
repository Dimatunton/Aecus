...
public class EquipmentSystem : MonoBehaviour
{
    ...
    public void switchEquipmentToRight(InputAction.CallbackContext context)
    {
        if (context.started)
        {
            ...
            {
                tempEquipped++;
                if(tempEquipped == (int)Equipments.Cane && !caneUnlocked)
                {
                    tempEquipped++;
                }
                if (tempEquipped == (int)Equipments.Shotgun && !shotgunUnlocked)
                {
                    return;
                }
